...
return null},Vc=!1;if(G.querySelectorAll)try{var Wc=G.querySelectorAll(":root");Wc&&1==Wc.length&&Wc[0]==G.documentElement&&(Vc=!0)}catch(a){}var Sc=Vc;var kd={},ld=null,md=Math.random();kd.s="GTM-52TNT8S";kd.Ob="561";kd.Ld="";var nd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},pd="www.googletagmanager.com/gtm.js";
var qd=pd,rd=null,sd=null,td=null,ud="//www.googletagmanager.com/a?id="+kd.s+"&cv=13",vd={},wd={},xd=function(){var a=ld.sequence||0;ld.sequence=a+1;return a};
...
Z.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=ek(c,"gtm.click");Qk(d)}}(function(b){Z.__cl=b;Z.__cl.b="cl";Z.__cl.g=!0;Z.__cl.priorityOverride=0})(function(b){if(!Vk("cl")){var c=V("document");nc(c,"click",a,!0);Wk("cl")}I(b.vtp_gtmOnSuccess)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.b="k";Z.__k.g=!0;Z.__k.priorityOverride=0})(function(a){return Sk(a.vtp_name,T("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
v=function(O){var M=[].slice.call(arguments,0);M[0]=u+M[0];r.apply(window,M)},y=function(O,M){return void 0===M?M:O(M)},x=function(O,M){if(M)for(var Ga in M)M.hasOwnProperty(Ga)&&v("set",O+Ga,M[Ga])},B=function(){var O=function(un,Fj,vn){if(!Qa(Fj))return!1;for(var od=Fa(Object(Fj),vn,[]),xg=0;od&&xg<od.length;xg++)v(un,od[xg]);return!!od&&0<od.length},M;if(d.vtp_useEcommerceDataLayer){var Ga=!1;Ga||(M=T("ecommerce",1))}else d.vtp_ecommerceMacroData&&(M=d.vtp_ecommerceMacroData.ecommerce);if(!Qa(M))return;M=Object(M);var Pb=Fa(f,"currencyCode",M.currencyCode);void 0!==Pb&&v("set","&cu",Pb);O("ec:addImpression",M,"impressions");if(O("ec:addPromo",M[M.promoClick?"promoClick":"promoView"],"promotions")&&M.promoClick){v("ec:setAction","promo_click",M.promoClick.actionField);return}for(var Da="detail checkout checkout_option click add remove purchase refund".split(" "),
bb="refund purchase remove checkout checkout_option add click detail".split(" "),cb=0;cb<Da.length;cb++){var lb=M[Da[cb]];if(lb){O("ec:addProduct",lb,"products");v("ec:setAction",Da[cb],lb.actionField);if(Pd)for(var yb=0;yb<bb.length;yb++){var Dc=M[bb[yb]];if(Dc){Dc!==lb&&J("GTM",13);break}}break}}},A=function(O,M,Ga){var Pb=0;if(O)for(var Da in O)if(O.hasOwnProperty(Da)&&(Ga&&t[Da]||!Ga&&void 0===t[Da])){var bb=w[Da]?Aa(O[Da]):O[Da];
